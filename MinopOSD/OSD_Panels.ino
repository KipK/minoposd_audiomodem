...
#endif
#ifdef JR_SPECIALS || JR_SPECIALSLIGHT
...
void panGPS(int first_col, int first_line) {
    osd.setPanel(first_col, first_line);
    osd.openPanel();
#ifdef JR_SPECIALS || JR_SPECIALSLIGHT	// I like it more one row style
...
void panVel(int first_col, int first_line) {
    osd.setPanel(first_col, first_line);
    osd.openPanel();
#ifdef JR_SPECIALS || JR_SPECIALSLIGHT	// I like it more this way
...
void panHeading(int first_col, int first_line) {
    osd.setPanel(first_col, first_line);
    osd.openPanel();
#ifdef JR_SPECIALS || JR_SPECIALSLIGHT	// show heading with compass point
