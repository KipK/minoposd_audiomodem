...
// use Audio FSK modem telemetry output
#define SOFT_MODEM
// use Default 5V reference for ADC instead of Internal 1.1v
#define ADC5V
...
//#define JR_SPECIALS
//#define JR_SPECIALSLIGHT // lightweight version to fit SoftModem
// JRChange: OP debug
//#define OP_DEBUG
// JRChange: GPS simulation
//#define GPS_SIMULATION
// OpenPilot 'NEXT' additional for unreleased 'NEXT' version or TauLabs fork.
